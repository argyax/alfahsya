...
function _fetch(client, httpRequest, _stega, query, _params = {}, options = {}) {
  ...
  return stega.enabled ? $request.pipe(
    combineLatestWith(
      from(
        import("./stegaEncodeSourceMap-NA77SIN6.js").then(function(n) {
...
function _listen(query, params, opts = {}) {
  ...
  return (token || withCredentials) && (esOptions.withCredentials = true), token && (esOptions.headers = {
    ...
    async function getEventSource() {
      const { default: EventSource2 } = await import("./browser-AGAL7X3Y.js");
      if (unsubscribed)
        return;
...
var LiveClient = class {
  ...
  events() {
    ...
    return new Observable((observer) => {
      ...
      async function getEventSource() {
        const EventSourceImplementation = typeof EventSource > "u" ? (await import("./browser-AGAL7X3Y.js")).default : EventSource;
        if (unsubscribed)
          return;
